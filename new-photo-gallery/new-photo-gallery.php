	...
	class New_Photo_Gallery {
		...
		?>
			...
			<div name="add-new-photos" id="add-new-photos" class="add-new-photos">
				...
				<div class="add-text">
					<?php esc_html_e( 'Add Photo', 'new-photo-gallery' ); ?>
		...
		public function _ajax_light_image_gallery()
		{
			if (current_user_can('manage_options')) {
				if (isset($_POST['lg_add_images_nonce']) && wp_verify_nonce($_POST['lg_add_images_nonce'], 'lg_add_images')) {
